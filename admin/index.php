...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" style="margin-top: 60px; margin-left:-40px " id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto ">
				...
				<li class="nav-item">
					<a class="nav-link" href="index.php?halaman=barang">Stok</a>
				</li>
			</ul>
		</div>
	</nav>
